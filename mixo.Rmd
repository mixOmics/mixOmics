...
rm(list=ls())
#setwd("~/Work/git/package-mixomics")
...
```{r,echo=TRUE,fig.width=8, fig.height=6,include=FALSE,eval=FALSE}
library(mixOmics)
...
#library(ellipse)
#library(rgl)
#source("mixOmics/R/selectVar.R")
#source("mixOmics/R/ipca.R")
...
if(length(ind.error)>0)
{
  ...
  cat("\n\n the best way forward is to source a script and traceback() to get the line that broke the code\n")
}else{
