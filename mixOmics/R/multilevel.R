...
multilevel <-function(object, ...){    #UseMethod("valid")
    cat('The multilevel module is now fully integrated as an argument in PLS, sPLS, PLS-DA and sPLS-DA methods.
    See ?pls ?spls ?plsda ?splsda for more details', '\n')
}
