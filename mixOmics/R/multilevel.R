...
#   Kim-Anh Le Cao, Queensland Facility for Bioinformatics, University of Queensland, Australia and the University of Queensland Diamantina Institute, Translational Research Institute, Brisbane, QLD
...
near.zero.var = TRUE)
{
    cat("The multilevel module is now fully integrated as an argument in PCA, PLS, sPLS, PLS-DA and sPLS-DA methods. Please use these functions as 'multilevel' one is now deprecated.
    See ?pca ?pls ?spls ?plsda ?splsda for more details", '\n')
