...
)
{
    ...
    size.axis = size.axis, size.legend = size.legend, size.legend.title = size.legend.title,
    ...
    display.names = display.names, add.legend = add.legend, abline = abline, star = star,
