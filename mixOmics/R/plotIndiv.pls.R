...
)
{
    ...
    size.axis = size.axis, legend.text.size = legend.text.size, legend.title.size = legend.title.size,
    ...
    col.per.group = col.per.group, style = style, study = "all", plot.ellipse  = plot.ellipse, ellipse.level  = ellipse.level,
    ...
    display.names = display.names, add.legend = add.legend, abline.line = abline.line, plot.star = plot.star,
    plot.ellipse = plot.ellipse, df.ellipse = df.ellipse, style = style, layout = layout, missing.col = missing.col,
